package com.example.rawggames.presentation.view.fragment
...
import com.example.rawggames.presentation.view.adapter.SearchGameAdapter
import com.example.rawggames.presentation.viewmodel.RawgViewModel
...
class SearchFragment : Fragment() {
        ...
        disposable.add(
            binding.edtSearch.textChanges()
                ...
                .subscribe({ input ->
                    ...
                    else rawgViewModel.getSearchGameData(input.toString())
    ...
    fun getSearchedGamesData() {
        ...
        rawgViewModel.getSearchGameData(query)
    }
